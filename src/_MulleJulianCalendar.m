...
- (struct MulleCalendarDate) mulleCalendarDateFromCanonicalDate:(mulle_canonicalcalendardate_t) sdn
{
   ...
   SdnToJulian( sdn, &year, &month, &day);
   date.year  = year;
   date.month = month;
   date.day   = day;
   return( date);
...
{
   return( JulianToSdn( date.year, date.month, date.day));
}
