...
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCCalendarFoundation-import.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCCalendarFoundation-import.h"
      ${PUBLIC_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCCalendarFoundation-include.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCCalendarFoundation-include.h"
      ${PUBLIC_HEADERS}
   )
endif()
...
# add ignored headers back in so that the generators pick them up
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCCalendarFoundation-import-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCCalendarFoundation-import-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCCalendarFoundation-include-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCCalendarFoundation-include-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
